...
/*     */ 
/*     */ 
/*     */ public enum CRCRMutator6
/*     */   implements MethodMutatorFactory
/*     */ {
/*  36 */   CRCR_MUTATOR6;
/*     */   
/*     */   private CRCRMutator6() {}
/*     */   
/*     */   private final class CRCRVisitor6 extends MethodVisitor {
/*     */     private final MutationContext context;
/*     */     
/*  43 */     public CRCRVisitor6(MutationContext context, MethodVisitor delegateVisitor) { super(Opcodes.ASM4, delegateVisitor);
...
/*     */     {
/*  50 */       Double replacement = Double.valueOf(-constant.doubleValue());
/*     */       
/*  52 */       if ((constant.doubleValue() != 0.0D) && (constant.doubleValue() != -1.0D) && (constant.doubleValue() != 1.0D) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/*  62 */       Float replacement = Float.valueOf(-constant.floatValue());
/*     */       
/*  64 */       if ((constant.floatValue() != 0.0F) && (constant.floatValue() != -1.0F) && (constant.floatValue() != 1.0F) && (shouldMutate(constant, replacement))) {
...
/*  72 */       Integer replacement = Integer.valueOf(-constant.intValue());
/*     */       
/*  74 */       if ((constant.intValue() != 0) && (constant.intValue() != -1) && (constant.intValue() != 1) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/*  83 */       Long replacement = Long.valueOf(-constant.longValue());
/*     */       
/*  85 */       if ((constant.longValue() != 0L) && (constant.longValue() != -1L) && (constant.longValue() != 1L) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/* 112 */       MutationIdentifier mutationId = this.context.registerMutation(CRCRMutator6.this, "Substituted " + constant + " with " + replacement);
/*     */       
/*     */ 
/*     */ 
...
/*     */   {
/* 276 */     return new CRCRVisitor6(context, methodVisitor);
/*     */   }
/*     */   
