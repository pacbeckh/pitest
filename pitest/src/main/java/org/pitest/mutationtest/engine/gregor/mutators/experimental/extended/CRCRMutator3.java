...
/*     */ 
/*     */ 
/*     */ public enum CRCRMutator3
/*     */   implements MethodMutatorFactory
/*     */ {
/*  36 */   CRCR_MUTATOR3;
/*     */   
/*     */   private CRCRMutator3() {}
/*     */   
/*     */   private final class CRCRVisitor3 extends MethodVisitor {
/*     */     private final MutationContext context;
/*     */     
/*  43 */     public CRCRVisitor3(MutationContext context, MethodVisitor delegateVisitor) { super(Opcodes.ASM4, delegateVisitor);
...
/*     */     {
/*  50 */       Double replacement = Double.valueOf(constant.doubleValue() == 0.0D ? 2.0D : 0.0D);
/*     */       
/*  52 */       if ((constant.doubleValue() != 0.0D) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/*  62 */       Float replacement = Float.valueOf(constant.floatValue() == 0.0F ? 2.0F : 0.0F);
/*     */       
/*  64 */       if ((constant.floatValue() != 0.0F) && (shouldMutate(constant, replacement))) {
...
/*  72 */       Integer replacement = Integer.valueOf(0);
/*     */       
/*  74 */       if ((constant.intValue() != 0) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/*  83 */       Long replacement = Long.valueOf(constant.longValue() == 0L ? 2L : 0L);
/*     */       
/*  85 */       if ((constant.longValue() != 0L) && (shouldMutate(constant, replacement))) {
...
/*     */     {
/* 112 */       MutationIdentifier mutationId = this.context.registerMutation(CRCRMutator3.this, "Substituted " + constant + " with " + replacement);
/*     */       
/*     */ 
/*     */ 
...
/*     */   {
/* 276 */     return new CRCRVisitor3(context, methodVisitor);
/*     */   }
/*     */   
